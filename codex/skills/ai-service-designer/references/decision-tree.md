# AI Service Designer â€” Decision Trees
...
## Tree 1 â€” "We spend hours keying data off PDFs into our system"

**Opportunity category:** 1 â€” Document intake & extraction.

```
Q1. What's the volume? (per week)
  < 20 docs/week   -> not worth automation; recommend workflow/template change only
  20â€“200 docs/week -> Templated document-extraction service (typical fit)
...
Q3. What's the cost of a wrong extraction?
  ...
  Minor inconvenience              -> Sample audit at 1â€“5%
...
## Tree 2 â€” "Our customer-support inbox is drowning"

**Opportunity category:** 2 â€” Customer-support chat (text).

```
Q1. What percentage of tickets are repetitive / low-complexity?
  < 30%   -> Don't automate responses; automate triage + routing only
  30â€“60%  -> LLM first-line responder with HITL escalation for anything else
...
## Tree 3 â€” "Missed calls are costing us jobs"

**Opportunity category:** 3 â€” Call triage & receptionist.
...
**Service shape:** Setup ($3Kâ€“$10K) + monthly per-line + minutes overage.
**Risk flags:** Missed emergencies. Document escalation SLA explicitly. Test the path before go-live.

---

## Tree 4 â€” "Our sales follow-up is inconsistent"

**Opportunity category:** 4 â€” Sales follow-up.
...
Q4. Follow-up vs cold-outreach?
  ...
  Cold outreach                           -> Delegate to the linkedin-optimizer skill (Week 4);
                                             avoid mass automated cold email â€”
...
## Tree 5 â€” "We need content but can't keep up"

**Opportunity category:** 5 â€” Content generation.
...
## Tree 6 â€” "Our email marketing is flat"

**Opportunity category:** 6 â€” Email sequences.
...
Q3. List size + hygiene?
  ...
  1,000â€“10,000                        -> Full nurture + segmentation
...
## Tree 7 â€” "We write proposals from scratch every time"

**Opportunity category:** 7 â€” Proposal & quote generation.

```
Q1. What percentage of each proposal is reused vs bespoke?
  > 70% reused -> Templated proposal-generation is a strong fit
  40â€“70%       -> LLM-assisted drafting
...
## Tree 8 â€” "We need to forecast demand / cash / staffing"

**Opportunity category:** 8 â€” Forecasting & planning.
...
Q4. Acceptable error band?
  Wide (Â±20%)                          -> Simple forecast fits
  Narrow (Â±5%)                         -> Requires strong data + probably a specialist partner
```
...
## Tree 9 â€” "We want to catch problems early (fraud / quality / errors)"

**Opportunity category:** 9 â€” Anomaly detection.
...
## Tree 10 â€” "We have data but no insights"

**Opportunity category:** 10 â€” Reporting & insights.
...
## Tree 11 â€” "We want to build our own chatbot"
...
## Tree 12 â€” "We want to use AI for sales outreach / cold email"
...
## Tree 13 â€” "We want to automate our bookkeeping"
...
## Tree 14 â€” "We want to use AI to write legal documents"
...
## Tree 15 â€” "We want AI to help with HR / recruitment"
...
## Meta-tree â€” How to use these trees
