# AI Service Designer â€” Templates

Eight fill-in-blank templates. Each one is a working artefact â€” copy it into a doc, fill the blanks, and it becomes the deliverable.

---

## Template 1 â€” AI opportunity scoring worksheet

Use when evaluating whether to build a candidate service. Score each row 1â€“10 (10 = strongest), then multiply by weight and sum.

**Candidate name:** _________________
**Brief description (1 sentence):** _________________

| # | Criterion | Weight | Score (1â€“10) | Weighted | Notes |
|-|-|-|-|-|-|
...
**Interpretation:**
- 7.5+ weighted â†’ strong candidate, proceed to brief.
- 6.0â€“7.4 â†’ iterate scope; low-scoring criteria need a fix.
- <6.0 â†’ kill or park.

**Hard kill rules (any one):**
- Score â‰¤ 3 on Data readiness â†’ no data, no service.
- Score â‰¤ 3 on AI capability fit â†’ red-zone task without HITL design.
- Score â‰¤ 3 on Risk profile â†’ regulated domain without accountability.

---

## Template 2 â€” Service brief
...
Target client profile:
  ...
  Maturity level (L1â€“L5):
  Typical problem/trigger:

Scope summary (3â€“5 bullets):
  -
  -
  -
  -
...
## Template 3 â€” Client discovery questionnaire

Use in discovery calls (F10). Send questions 1â€“5 in advance; leave 6â€“10 for the call.
...
3. Where does the work live right now? (spreadsheets, email, CRM, phone, paper â€” list the systems)
4. What data is involved? (documents, calls, emails, records â€” list the types)
...
## Template 4 â€” Scope of work (SOW)
...
## Template 5 â€” Pricing-model selector
...
## Template 6 â€” Risk register

Attach to every SOW. Expand rows as needed.

```
RISK REGISTER â€” [Engagement name]
...
R5  | Scope drift â€” client asks for features beyond scope
    | High | Medium
...
R7  | Compliance exposure â€” regulated content produced without review
    | Low | High
...
6. CLIENT COMMUNICATIONS
   Weekly status email â€” Friday, 3pm, to [name]
   Monthly review call â€” [day of month]
   Outage notice â€” within 30 min of detection, to [name + channel]
...
Relational
  ...
  [ ] references/case-study consent discussed (optional for later)
