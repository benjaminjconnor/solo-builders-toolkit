...
| 2 | Automation scope is bounded â€” the service has a clear start and stop | Service starts at event X, produces output Y, stops when Z | Open-ended "AI help across the business" |
| 3 | Data access is confirmed â€” we've seen sample data or have a path to it | Sample docs, API access, or test dataset in hand | "We'll figure out data later" |
...
| 5 | HITL pattern is chosen and documented | Review-before-send / sample audit / escalation-on-uncertainty â€” one is picked | "We'll add review if issues come up" |
...
| 10 | Gross margin at target price â‰¥ 50% | Tech costs + labour costs + overhead < 50% of fee | Margin unknown or under 50% |

**Interpretation:**
- 9â€“10 PASS â†’ proceed.
- 7â€“8 PASS with specific UNKNOWNs â†’ clarify in next discovery call.
- Any FAIL on 1, 3, 4, or 6 â†’ do not proceed without fixing. These are load-bearing.
- 5 or fewer PASS â†’ service is not ready; start again from the service brief.

---

## Layer 2 â€” Full 60-item audit
...
### Section 1 â€” Outcome + problem fit (10 items)
...
- [ ] 1.6 Problem shape matches a decision tree in `references/decision-tree.md`
...
### Section 2 â€” AI capability + data fit (8 items)
...
- [ ] 2.6 Data quality assessed â€” sample reviewed for errors, inconsistencies, gaps
- [ ] 2.7 Data lineage documented â€” who owns it, where it's sourced, how it's refreshed
- [ ] 2.8 Evaluation plan exists â€” how we'll measure output quality (held-out set, sample audit, etc.)

**Section 2 score:** ___ / 16

---

### Section 3 â€” Scope + boundary (6 items)

- [ ] 3.1 Scope sentence is â‰¤ 3 lines
...
### Section 4 â€” Pricing + margin (8 items)
...
- [ ] 4.7 Per-client labour cost calculated (hours Ã— rate)
- [ ] 4.8 Gross margin at target price â‰¥ 50%

**Section 4 score:** ___ / 16

---

### Section 5 â€” Risk + compliance (8 items)
...
### Section 6 â€” HITL + operations (6 items)
...
### Section 7 â€” Vendor + tech-stack (6 items)
...
### Section 8 â€” Offer-ladder + productisation (8 items)
...
- [ ] 8.8 One-liner passes "10-second read test" â€” does a skim-reader understand the outcome?
...
**Interpretation:**
- 100â€“120 (83%+) â€” ready to launch.
- 80â€“99 (67â€“82%) â€” fix gaps in the lowest-scoring section first.
- 60â€“79 (50â€“66%) â€” significant gaps; prioritise Sections 1, 2, 4.
- <60 (<50%) â€” service needs a rebuild, not a patch.
...
1. **Outcome + problem fit (Section 1)** â€” nothing else matters if the outcome isn't clear and measurable.
2. **AI capability + data fit (Section 2)** â€” no data, no service; wrong capability, no outcome.
3. **Scope + boundary (Section 3)** â€” without a bounded scope, pricing is fiction.
4. **Pricing + margin (Section 4)** â€” if you can't make money at target price, don't build.
5. **Risk + compliance (Section 5)** â€” launch with eyes open; never post-hoc.
6. **HITL + operations (Section 6)** â€” design oversight before the first failure.
7. **Vendor + tech-stack (Section 7)** â€” de-risk vendor continuity before production volume.
8. **Offer-ladder + productisation (Section 8)** â€” only worth investing once the above are solid.
...
| Quarter | Focus | Depth |
|-|-|-|
| Q1 | Full audit (all 8 sections) | Deep â€” set baseline |
| Q2 | Sections 4, 5, 6 (margin, risk, ops) | Medium |
| Q3 | Sections 2, 7 (capability drift, vendor landscape) | Medium |
| Q4 | Full audit + annual strategy review | Deep â€” inform next year's plan |
