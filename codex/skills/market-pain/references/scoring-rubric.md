...
## Phase 2 â€” Problem scoring (6 dimensions, 1â€“5 each, max 30/30)
...
|-|-|-|
| 1 | Barely mentioned | 1â€“2 total mentions across all sources. Could be one grumpy user. |
| 2 | Occasional | 3â€“5 mentions across 2+ sources. Real but not widespread. |
| 3 | Common | 6â€“10 mentions across 3+ sources. Clear recurring theme. |
| 4 | Widespread | 11â€“15 mentions across 4+ sources. Appears in multiple Reddit threads, review sites, forum posts. |
| 5 | Dominant | 15+ mentions across 5+ sources. The complaint shows up in almost every thread in the space. |

**Worked case â€” high**: A plumbing subreddit thread on "biggest business headaches" has 47 comments; 22 of them mention missed after-hours calls losing emergency work. Software review sites for trade CRMs show 60+ user reviews complaining about the same thing. **Frequency = 5**.

**Worked case â€” low**: In researching accounting firms, you find one Reddit post where someone complains about "client portal UX" with 4 upvotes and no replies. No other source mentions it. **Frequency = 1**.

**Ambiguous case**: The complaint appears in 8 reviews of one product but nowhere else across the industry. Is it frequency 3 (common) or 1 (one product's users)? Apply the lower-bound rule: **Frequency = 2** (occasional â€” evidence is real but not diverse).
...
**Worked case â€” high**: Hotel/HVAC business in 40Â°C summer heat has missed 3 after-hours emergency calls this week; owner posts "I'm losing $5K in jobs weekly because we can't answer the phone overnight. Need a solution NOW." **Urgency = 5**.

**Worked case â€” medium**: Accountant posts "document chasing is painful but we just accept it as part of the job." Confirms the problem, no active hunting. **Urgency = 2**.
...
| 3 | Small paid tool | People pay $20â€“$50/mo for a partial solution (often an incomplete SaaS tool). |
| 4 | Meaningful spend | People pay $100â€“$500/mo for solutions (VAs, answering services, mid-tier software). |
| 5 | Large spend | People pay $500+/mo, sometimes thousands (hire staff, enterprise tools, agencies). |

**Worked case â€” high**: Plumbing businesses routinely spend $300â€“$600/mo on answering services or dedicated receptionists. Industry forum threads reference VA platforms costing $1,500/mo for 24/7 coverage. **Spending = 4**.

**Worked case â€” low**: Independent contractors "want" an AI assistant to write proposals. Nobody is paying for this today; nobody has mentioned current spend in any Phase 1 source. **Spending = 1**.
...
**Inverted scale** â€” lower score = harder to switch = less opportunity.
...
**Worked case â€” high**: HVAC business owner posts: "I've been on [Software X] for 4 years and I'd leave tomorrow if I could find something that actually worked." They haven't left because they haven't found a good alternative. **Switch = 5** (score the opportunity, not the inertia â€” they're motivated).

**Worked case â€” low**: Large accounting firm has 40 staff trained on a proprietary PMS with years of client data inside. Switching means retraining staff, migrating data, and renegotiating compliance workflows. **Switch = 1**.
...
| 2 | Small | 1Kâ€“5K businesses. Plausible solo-builder play, narrow TAM. |
| 3 | Moderate | 5Kâ€“20K businesses. Comfortable size for solo with room to grow. |
| 4 | Large | 20Kâ€“100K businesses. Strong TAM; will attract competitors. |
| 5 | Very large | 100K+ businesses. National or cross-vertical scale. |

**Worked case â€” high**: Plumbing in a mid-size country, ~28K businesses. **Market = 4**.

**Worked case â€” low**: Licensed ski-lift inspectors in one country: <200 nationwide. **Market = 1**.
...
**Worked case â€” high**: A "missed calls â†’ SMS auto-reply" tool for trades uses Twilio, standard webhooks, and a small chat UI. You've built three Twilio integrations before. **Build = 5**.

**Worked case â€” low**: A tool that does real-time compliance checking against a gated industry's proprietary database, which requires: regulatory approval, encrypted data handling, and an integration that only approved partners get. **Build = 1**.
...
- **25â€“30**: Exceptional opportunity. Run Phase 2.5 immediately.
- **20â€“24**: Viable. Run Phase 2.5 and expect some kills on economics.
- **15â€“19**: Weak. Likely not worth pursuing; kill unless multiple problems in this vertical all score 15â€“19 and the overall pattern is compelling.
- **Below 15**: Kill.
...
## Phase 4 â€” Post-call validation rubric
...
**YES requires**: their own words + their own example. If you described the problem and they said "yeah, that's a thing" â€” that's PARTIAL, not YES.

### Dimension 2: Urgency (1â€“5)
...
**Vignette â€” urgency 3**: Prospect says: "We lose maybe 10 hours a week on this. I know it's costing us." They've quantified pain but aren't actively hunting. **Score = 3.**

**Vignette â€” urgency 4**: Prospect says: "We're using [Tool A] and [Tool B] and a VA to patch it together. Still not working. I spend every Sunday wondering if there's a better way." They're actively searching. **Score = 4.**

**Vignette â€” ambiguous**: Prospect says: "It's fine. I mean, it's not fine, but it's fine." Emotional intensity says more than the words. Down-score: **Score = 2**.
...
**Vignette â€” ambiguous handling**: Prospect says "I'd definitely pay something. Maybe $50/mo? I'd need to see it work first." Your target is $149/mo. Score: **YES below target @ $50**. Note the $99 gap â€” your price or their willingness has to move.
...
Tally:
- Count of problem-confirmed (YES) â‰¥ 7 â†’ problem is real
- Average urgency across all 10 calls â‰¥ 3 â†’ problem has pull
- Current-spend (YES + amount) â‰¥ 5 â†’ replacement budget exists
- Willingness-to-pay (YES @ target) â‰¥ 4 â†’ price holds
...
2. **Are any dimensions all 5s?** Rare. If three dimensions score 5, re-examine â€” you may be excited and over-scoring. The lower-bound rule applies.
