...
Read Example 1 first â€” it's the cleanest teaching case. Examples 2 and 3 show trickier situations where the methodology pays for itself.

---

## Example 1 â€” HVAC contractors (best teaching case)
...
`market-pain hvac contractors in [country]` skill input

No existing tracker entry â€” fresh run.

### Phase 1 â€” Problem mining

Sources accessed (Phase 1 citation trail):
- r/hvacadvice (subreddit, ~180K members)
- r/smallbusiness filtered for "HVAC"
- 6 software review pages â€” found via Google "[vertical] software reviews" and G2/Capterra "[vertical] CRM", then picked the top 5-6 by review volume (mix of vertical-specific CRMs, general field-service platforms, and AI phone add-ons)
...
3. Seasonal scheduling chaos â€” summer AC / winter heating peaks (28 mentions)
...
- **Missed calls urgency = 5**: Multiple owners cite $500â€“$1,200 per missed call. One report: "2â€“3 after-hours missed calls per month cost us $18Kâ€“$48K/year." This is crisis-level.
...
- **Customer comms spending = 2**: Owners know it's a problem but don't pay to fix it. This is a classic "active pain, no current spend" combo â€” you're creating a new budget line, not swapping an existing one.

**Phase 2 kill switch**: At least one problem 20+/30. Five problems qualify. **PASSES.** Proceed to Phase 2.5.

### Phase 2.5 â€” Economic viability
...
- Owner-operator (1â€“3 staff): ~40% of the market, ~10K businesses. Likely can't afford $300+/mo.
- Small/medium (4â€“20 staff): ~45%, ~11K businesses. Target segment.
- Large (20+ staff): ~15%, ~3.5K businesses. Can afford premium tools but often use enterprise platforms.

**Price ceiling math**:
- Current spend on answering services: $300â€“$600/mo (replacement spend)
- Current spend on field service software: $50â€“$200/mo
- Industry gross margin: 18â€“25% on service revenue
- Price ceiling for small/medium segment: **$150â€“$400/mo** (bounded by willingness to pay, not just margin)

**Top problem â†’ sell type**:
...
- 11K Ã— 1% = 110 customers
- 110 Ã— $199/mo = **$21.9K MRR**. Viable for a solo.

**Platform risk**: GREEN. Email, SMS, voice, web. No single-platform dependency.

**Kill switch #3**: Viable segment â‰¥1K at â‰¥$75/mo? Yes â€” 11K small/medium businesses at $150+/mo. **PASSES.**

### Phase 3 â€” Solution gap analysis
...
Competitors:
- [Vendor A] â€” AI phone agent, from $29/mo, platform-generic
- [Vendor B] â€” vertical-specific AI receptionist, $150â€“$300/mo
- [Vendor C] â€” full CRM with AI calls module, $300+/mo

Gap: none. Market is served. Even the best "sub-gaps" (better after-hours triage, emergency routing logic) are FEATURE-level â€” competitors can add them in 1â€“2 sprints. **Confidence: LOW on finding a durable gap here.**
...
Gap: **GREENFIELD**. Nobody auto-triggers vertical-seasonal maintenance campaigns with multi-channel escalation (email â†’ SMS â†’ call) tied to the vertical's actual seasonal rhythm.
- Feature gap? Partial â€” incumbents could add it, but their data models don't include seasonal metadata. STRUCTURAL for 6â€“12 months.
...
- None chain job-stage-specific comms (dispatch â†’ arrival â†’ in-progress â†’ completion â†’ follow-up)

Gap: FEATURE gap. Existing tools offer pieces; nobody offers the full chain as a single product. Competitors could close this in 1â€“2 sprints.
- Durability: LOW.
- **Confidence: MEDIUM**.
...
| Seasonal automation | Greenfield â†’ Structural | HIGH | MED-HIGH | **Build first** |
| Customer comms | Feature | MEDIUM | LOW | Build second, fast |

Recommended product positioning: **"Seasonal campaign automation for HVAC contractors"** â€” lead with the greenfield, layer in comms chain as secondary.

### Phase 4 â€” Conversation guide

Target: 10 discovery calls with HVAC business owners, 5â€“20 staff segment, before any build.
...
- GO: 7+ calls confirm problem, avg urgency â‰¥ 3, current-spend â‰¥ 5 calls, willingness-to-pay â‰¥ 4 calls at $199/mo
...
- GO (likely 40â€“60% probability): build seasonal campaign automation as the flagship, comms chain as v2.
- AMBIGUOUS (30â€“40%): seasonal campaigns confirmed but willingness-to-pay softer than $199; iterate on pricing or packaging.
- NO-GO (10â€“20%): seasonal concept doesn't resonate; owners say they'd "just remember" to send reminders themselves.

---

## Example 2 â€” Accounting firms (high competitor density trap)
...
`market-pain accounting firms in [country]` skill input

### Phase 1 â€” Problem mining

11 complaint clusters. Top 3 by surface signal:
1. Chasing clients for documents â€” "request one thing, get 4 billion unrelated things"
2. Onboarding new clients â€” 6â€“8 weeks, manual
3. Scope creep without invoicing for it â€” ~$100K/yr lost per firm (industry average)
...
**Phase 2 kill switch**: PASSES. On paper, this looks incredible â€” a 27/30 problem.

### Phase 2.5 â€” Economic viability

- Total firms in vertical: ~35K
- Addressable segment (small-to-mid firms, 3â€“25 staff): ~15K
- Current stack spend: $300â€“$1,500/mo per firm
- Price ceiling: $200â€“$500/mo for a single-problem tool

MRR at 1% penetration: 150 Ã— $299 = $44.8K MRR. **Very viable**.
...
- [Vendor D] â€” purpose-built document request platform, $75â€“$200/mo
- [Vendor E] â€” integrated practice management with document workflows, $300+/mo
- [Vendor F] â€” document automation add-on, $100+/mo
- [Vendor G] â€” niche competitor, email-only reminders, $50/mo
- 3 additional sub-$100/mo indie tools

Competitor density: **HIGH.**

Gap-hunting:
- Multi-channel escalation (email â†’ SMS â†’ voice)? Only [Vendor D] does email+SMS. Nobody does voice. â†’ Potential gap.
- Integration with the top 3 accounting platforms? All major competitors do this.
- Pricing disruption? The segment has tools at $50, $100, $200, $300 â€” every price point is covered.
...
â†’ **FEATURE gap, LOW durability.** Would be copied in months.
...
## Example 3 â€” "Nothing here" (the Phase 1 kill)
...
`market-pain licensed massage therapists in [country]` skill input
...
- 4 software review pages â€” found via G2/Capterra searches for "[vertical] booking software" and "[vertical] practice management", picked top 4 by review volume
- 1 national classification-code registry

Results after ~60 min of research:

**Top surface complaints (all low-frequency)**:
1. "Insurance billing is a hassle" â€” 3 mentions across 2 sources
2. "No-shows are annoying" â€” 2 mentions, software handles this already
3. "Finding clients is hard" â€” 2 mentions, not a tooling problem

No single complaint has more than 3 verifiable mentions. Most threads on the subreddit are about technique, not business ops. Software reviews are overwhelmingly positive â€” users are content with current tools.
...
> **Licensed massage therapists â€” KILLED at Phase 1.**
> 
...
> - Incumbents may be "good enough" â€” modest pain with adequate solutions, not a gap.
...
- Researcher B "feels" the vertical should work, pushes through Phases 2â€“4 anyway, builds an MVP based on weak signal, launches, gets no traction. Total time: 6 months.
...
```
| Licensed massage therapists | [geography] | 2026-05-10 | KILLED P1 | â€” | â€” | docs/research/massage-therapist-pain-report.md | Don't build. Revisit only with new signal. |
```
...
**Healthy vertical signature** (Example 1 â€” HVAC):
...
**Trap vertical signature** (Example 2 â€” accounting):
...
**Kill-fast signature** (Example 3 â€” massage therapy):
...
2. If Phase 1 is producing thin results, compare to Example 3. If you're at 75 min and under 5 complaint clusters, you have your answer â€” kill and move on.
3. When writing the final report, use these examples' structure as your template. Executive summary â†’ Phase 1 â†’ Phase 2 â†’ Phase 2.5 â†’ Phase 3 â†’ Phase 4 â†’ Recommendation.
